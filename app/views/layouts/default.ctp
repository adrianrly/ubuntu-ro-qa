	...
	<div id="main">
		...
		<div class="wrapper" id="header_main">
			  <ul class="tabs">
					...
					?>
					<a href="/tags">Tags</a>
			    	<a href="/questions/unanswered">Unsolved</a>
				...
				<ul class="xoxo">
					<li id="text-3" class="widgetcontainer widget_text">			
						<div class="textwidget">
							...
							<p><a href="http://ubuntu.ro/feed"><?=$html->image('rss.png', array('width' => '15px', 'alt' => 'RSS'))?><a href="http://www.facebook.com/ubuntulinux"><?=$html->image('fb.png', array('width' => '15px', 'alt' => 'Facebook'))?></a> <a href="http://twitter.com/planetubuntu"><?=$html->image('tw.png', array('width' => '15px', 'alt' => 'Twitter'))?></a></p>
						</div>
					</li>
				</ul>
			</div><!-- #first .aside -->
